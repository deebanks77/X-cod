...
function Feedback() {
  ...
  return (
    <div className="feedback font-poppins h-[420px] midTablet:h-[500px] laptop:h-[600px] desktop:h-[700px] w-full max-h-[847px] bg-[#4CC9F0] bg-gradient-to-r border-2 border-transparent px-3 midTablet:px-5">
      <div>
