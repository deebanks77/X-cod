...
function Hero() {
  ...
  return (
    <div className="flex flex-col items-center mt-[32px] tablet:mt-[38px] laptop:mt-[45px] px-5 relative max-w-[1400px] mx-auto">
      ...
      <div className="circle hidden laptop2:block laptop:absolute top-[100px] laptop2:left-[50px] desktop:left-[100px] w-[400px] h-[400px] border-[#858585] laptop:border-[#858585]  border-[2px] rounded-[50%]">
      ...
      <div className="block rectangle w-[100%] h-[280px] mobile2:h-[350px]  tablet:w-[550px] tablet:h-[400px] bigTablet:w-[600px] bigTablet:h-[450px] laptop:w-[650px] laptop:h-[500px] desktop:w-[700px] desktop:h-[500px] relative bg-white tablet:mt-[30px] bigTablet:mt-[60px] laptop:mt-[90px] desktop:mt-[120px]  rounded-md animate-scale px-[10px] pb-[10px]">
